    ...
    <header className="max-w-full shadow-lg shadow-cyan-500/50 p-3 text-cyan-500 mb-6">
      <nav className="flex max-w-[1200px] mx-auto justify-between items-center">
        ...
        <ul className="xs:hidden sm:flex font-medium gap-5">
          ...
          {user == null ? (
            <li className="hover:text-cyan-300 hover:underline px-2 py-1">
              <Link to={"/login"}>Login</Link>
            </li>
          ) : (
            <>
              <li
                className=" cursor-pointer hover:text-cyan-300 hover:underline px-2 py-1"
                onClick={logout}
              >
                Logout
              </li>
        ...
        >
          <ul className="w-[40%] h-full pt-1 flex flex-col text-xl bg-black text-black font-medium gap-1">
            <li className="hover:text-cyan-300 hover:underline px-2 py-1 cursor-pointer bg-blue-600">
              <select
                name="listing"
                id="listing"
                className="bg-transparent cursor-pointer rounded"
            ...
            {user == null ? (
              <li
                className="hover:text-cyan-300 hover:underline px-2 py-1 bg-blue-600"
                onClick={() => {
                  setOpenMenu(!OpenMenu);
                }}
              >
